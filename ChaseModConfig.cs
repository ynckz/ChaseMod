...
public sealed class ChaseModConfig : BasePluginConfig
{
    ...
    [JsonPropertyName("knifeCooldown")] public float KnifeCooldown { get; set; } = 5.0f;
    [JsonPropertyName("stunThrowTime")] public float StunThrowTime { get; set; } = 2.0f;
    [JsonPropertyName("stunFreezeTime")] public float StunFreezeTime { get; set; } = 4.0f;
    ...
    [JsonPropertyName("maxTerroristWinStreak")] public int MaxTerroristWinStreak { get; set; } = 3;
    ...
    [JsonPropertyName("ctStartFreezeTime")] public float RoundStartFreezeTime { get; set; } = 10.0f;
